document.querySelector("#pic-1").addEventListener('click', showPic1)
document.querySelector("#pic-2").addEventListener('click', showPic2)
document.querySelector("#pic-3").addEventListener('click', showPic3)
document.querySelector("#pic-4").addEventListener('click', showPic4)
document.querySelector("#pic-5").addEventListener('click', showPic5)
document.querySelector("#pic-6").addEventListener('click', showPic6)
document.querySelector("#pic-7").addEventListener('click', showPic7)
document.querySelector("#pic-8").addEventListener('click', showPic8)
...
function showPic1(){
	...
	document.querySelector("#pic5").style.display = "none";
	document.querySelector("#pic6").style.display = "none";
	document.querySelector("#pic7").style.display = "none";
	document.querySelector("#pic8").style.display = "none";
}
